# Fix Code Loop × 10 — All Modules

Run up to 10 complete bounded loops of analysis → design → specification → implementation.
...
Find and fix correctness issues in the target repository using up to 10 loops of
...
- Stop after 10 successful loops, or earlier if no confirmed bounded issues remain.
