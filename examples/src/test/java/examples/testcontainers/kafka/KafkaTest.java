...
public class KafkaTest {
    ...
    public static void arguments(final @NonNull ArgumentsCollector collector) throws IOException {
        KafkaTestEnvironment.createTestEnvironments().forEach(collector::addArgument);
    }
     ...
     *
     * @param testEnvironment testEnvironment
     * @return a KafkaProducer
     */
    private static KafkaProducer<String, String> createKafkaProducer(
            final @NonNull KafkaTestEnvironment testEnvironment) {
