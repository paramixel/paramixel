 ...
 */
public class TansuTestEnvironment implements Named {
     ...
     */
    public TansuTestEnvironment(final @NonNull String dockerImageName) {
     ...
     */
    public void initialize(final @NonNull Network network) throws IOException {
        for (int i = 0; i < 10; i++) {
     ...
     */
    private static void safeStop(final @NonNull GenericContainer<?> container) {
        if (container == null) {
            return;
        }
