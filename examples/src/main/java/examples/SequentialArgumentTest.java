...
public class SequentialArgumentTest {
    ...
    public static Action actionFactory() {
        ...
        Action arguments = arguments(suiteName);
        ...
        var suiteBuilder = Container.builder(suiteName)
                .policy(Container.Policy.builder()
                        ...
                        .build());
        suiteBuilder.child(arguments);
        suiteBuilder.child(validate);

        return suiteBuilder.build();
    }

    private static Action arguments(String suiteName) {
        var argumentsBuilder = Container.builder(suiteName)
                .policy(Container.Policy.builder()
                        .childMode(Container.ChildMode.INDEPENDENT)
                        .build());
