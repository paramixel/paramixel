...
public class BufstreamExample {
    ...
    record Attachment(Network network, BufstreamTestEnvironment environment, String message) {}

    @Paramixel.ActionFactory
    public static Action actionFactory() throws Throwable {
        var argumentActions = new ArrayList<Action>();

        for (BufstreamTestEnvironment environment : BufstreamTestEnvironment.createTestEnvironments()) {
                ...
                try (var consumer = createKafkaConsumer(attachment.environment())) {
                    ...
                    for (ConsumerRecord<String, String> consumerRecord : consumerRecords) {
                        LOGGER.info(
                                ...
                                attachment.environment().name(), consumerRecord.value());
        ...
        return Parallel.of("BufstreamExample", argumentActions);
    }
