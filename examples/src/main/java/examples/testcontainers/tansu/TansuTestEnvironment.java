...
import examples.testcontainers.util.HostPortSocketWaitStrategy;
...
public class TansuTestEnvironment {
    ...
    public TansuTestEnvironment(final String dockerImageName) {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            try {
                container = new GenericContainer<>(DockerImageName.parse(dockerImageName))
                        ...
                        .waitingFor(new HostPortSocketWaitStrategy(9092))
    ...
    public static List<TansuTestEnvironment> createTestEnvironments() throws IOException {
        var envs = new ArrayList<TansuTestEnvironment>();
    ...
    private static void bindHostPorts(final CreateContainerCmd createContainerCmd, final int HOST_KAFKA_PORT) {
