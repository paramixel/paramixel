...
public class TansuExample {
    ...
    private static class TestAttachment {
        ...
        public TansuTestEnvironment environment;
    ...
    public static Action actionFactory() throws Throwable {
        return Parallel.of(
                "TansuExample",
                TansuTestEnvironment.createTestEnvironments().stream()
                        .map(TansuExample::createLifecycleAction)
                        .toList());
    }

    private static Action createLifecycleAction(TansuTestEnvironment environment) {
