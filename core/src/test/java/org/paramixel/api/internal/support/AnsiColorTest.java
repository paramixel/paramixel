...
class AnsiColorTest {
    ...
    void resetFormatShouldWrapText() {
        ...
        assertThat(result).startsWith(AnsiColor.RESET.code());
    ...
    void boldGreenTextFormatShouldWrapAndAppendReset() {
        ...
        assertThat(result).startsWith(AnsiColor.BOLD_GREEN_TEXT.code());
        assertThat(result).endsWith(AnsiColor.RESET.code());
    ...
    void boldRedTextFormatShouldWrapAndAppendReset() {
        ...
        assertThat(result).startsWith(AnsiColor.BOLD_RED_TEXT.code());
        assertThat(result).endsWith(AnsiColor.RESET.code());
    }
    ...
    void boldBlueTextFormatShouldWrapAndAppendReset() {
        ...
        assertThat(result).startsWith(AnsiColor.BOLD_BLUE_TEXT.code());
        assertThat(result).endsWith(AnsiColor.RESET.code());
    }
    ...
    void boldOrangeTextFormatShouldWrapAndAppendReset() {
        ...
        assertThat(result).startsWith(AnsiColor.BOLD_ORANGE_TEXT.code());
        assertThat(result).endsWith(AnsiColor.RESET.code());
    }
    ...
    void boldWhiteTextFormatShouldWrapAndAppendReset() {
        ...
        assertThat(result).startsWith(AnsiColor.BOLD_WHITE_TEXT.code());
        assertThat(result).endsWith(AnsiColor.RESET.code());
    }
    ...
    void boldOrangeGetCodeShouldReturnOrangeSequence() {
        assertThat(AnsiColor.BOLD_ORANGE_TEXT.code()).isEqualTo("\033[1;33m");
    }

    @Test
    @DisplayName("BOLD_WHITE_TEXT getCode should return white escape sequence")
    void boldWhiteGetCodeShouldReturnWhiteSequence() {
        assertThat(AnsiColor.BOLD_WHITE_TEXT.code()).isEqualTo("\033[1;37m");
    }
}
