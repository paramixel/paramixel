...
class ClassGraphClassLoaderHandler implements ClassLoaderHandler {
    ...
    public static boolean canHandle(final Class<?> classLoaderClass, final LogNode log) {
        final boolean matches = ClassLoaderFinder.classIsOrExtendsOrImplements(
                classLoaderClass, "nonapi.org.paramixel.classgraph.io.github.classgraph.ClassGraphClassLoader");
        if (matches && log != null) {
