...
public class BaseTypeSignature extends TypeSignature {
    ...
    /* (non-Javadoc)
     * @see nonapi.org.paramixel.classgraph.io.github.classgraph.ScanResultObject#loadClass()
     */
    @Override
    Class<?> loadClass() {
        return getType();
    ...
    /* (non-Javadoc)
     * @see nonapi.org.paramixel.classgraph.io.github.classgraph.ScanResultObject#loadClass(java.lang.Class)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see nonapi.org.paramixel.classgraph.io.github.classgraph.ScanResultObject#setScanResult(ScanResult)
     */
    @Override
