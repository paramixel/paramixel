...
public class ModuleFinder {
     ...
     *            the layer order
     */
    private void findLayerOrder(
            final Object /* ModuleLayer */ layer,
        ...
        if (layerVisited.add(layer)) {
            ...
            final List<Object> /* List<ModuleLayer> */ parents =
                    (List<Object>) reflectionUtils.invokeMethod(/* throwException = */ true, layer, "parents");
            if (parents != null) {
     ...
     * @return the list
     */
    private List<ModuleRef> findModuleRefs(
            final LinkedHashSet<Object> layers, final ScanSpec scanSpec, final LogNode log) {
        if (layers.isEmpty()) {
        ...
        for (final Object /* ModuleLayer */ layer : layerOrderFinal) {
            final Object /* Configuration */ configuration =
                    reflectionUtils.invokeMethod(/* throwException = */ true, layer, "configuration");
            if (configuration != null) {
                // Get ModuleReferences from layer configuration
                @SuppressWarnings("unchecked")
                final Set<Object> /* Set<ResolvedModule> */ modules = (Set<Object>)
                        reflectionUtils.invokeMethod(/* throwException = */ true, configuration, "modules");
                if (modules != null) {
                    final List<ModuleRef> modulesInLayer = new ArrayList<>();
                    for (final Object /* ResolvedModule */ module : modules) {
                        final Object /* ModuleReference */ moduleReference =
                                reflectionUtils.invokeMethod(/* throwException = */ true, module, "reference");
     ...
     * @return the list
     */
    private List<ModuleRef> findModuleRefsFromCallstack(
        ...
        if (callStack != null) {
            for (final Class<?> stackFrameClass : callStack) {
                final Object /* Module */ module =
                        reflectionUtils.invokeMethod(/* throwException = */ false, stackFrameClass, "getModule");
                if (module != null) {
                    final Object /* ModuleLayer */ layer =
                            reflectionUtils.invokeMethod(/* throwException = */ true, module, "getLayer");
                    if (layer != null) {
                        layers.add(layer);
        ...
        if (moduleLayerClass != null) {
            final Object /* ModuleLayer */ bootLayer =
                    reflectionUtils.invokeStaticMethod(/* throwException = */ false, moduleLayerClass, "boot");
            if (bootLayer != null) {
    ...
    public ModuleFinder(
            ...
            final ScanSpec scanSpec,
            final boolean scanNonSystemModules,
            final boolean scanSystemModules,
