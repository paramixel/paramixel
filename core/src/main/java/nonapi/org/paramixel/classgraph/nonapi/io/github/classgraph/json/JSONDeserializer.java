...
public class JSONDeserializer {
     ...
     * @return the object
     */
    private static Object jsonBasicValueToObject(
            final Object jsonVal, final Type expectedType, final boolean convertStringToNumber) {
        if (jsonVal == null) {
            return null;
        ...
        if (rawType == String.class) {
            if (!(jsonVal instanceof CharSequence)) {
                throw new IllegalArgumentException(
                        "Expected string; got " + jsonVal.getClass().getName());
            }
            ...
            if (!(jsonVal instanceof CharSequence)) {
                throw new IllegalArgumentException(
                        "Expected CharSequence; got " + jsonVal.getClass().getName());
            }
            return jsonVal;
            ...
            if (!(jsonVal instanceof Integer)) {
                throw new IllegalArgumentException(
                        "Expected integer; got " + jsonVal.getClass().getName());
            }
            return jsonVal;
            ...
            if (!(isLong || isInteger)) {
                throw new IllegalArgumentException(
                        "Expected long; got " + jsonVal.getClass().getName());
            }
            if (isLong) {
                return jsonVal;
            } else {
            ...
            if (!(jsonVal instanceof Integer)) {
                throw new IllegalArgumentException(
                        "Expected short; got " + jsonVal.getClass().getName());
            }
            ...
            if (!(jsonVal instanceof Double)) {
                throw new IllegalArgumentException(
                        "Expected float; got " + jsonVal.getClass().getName());
            }
            ...
            if (!(jsonVal instanceof Double)) {
                throw new IllegalArgumentException(
                        "Expected double; got " + jsonVal.getClass().getName());
            }
            return jsonVal;
            ...
            if (!(jsonVal instanceof Integer)) {
                throw new IllegalArgumentException(
                        "Expected byte; got " + jsonVal.getClass().getName());
            }
            final int intValue = (Integer) jsonVal;
            ...
            if (!(jsonVal instanceof CharSequence)) {
                throw new IllegalArgumentException(
                        "Expected character; got " + jsonVal.getClass().getName());
            }
            ...
            if (!(jsonVal instanceof Boolean)) {
                throw new IllegalArgumentException(
                        "Expected boolean; got " + jsonVal.getClass().getName());
            }
            return jsonVal;
        } else if (Enum.class.isAssignableFrom(rawType)) {
            if (!(jsonVal instanceof CharSequence)) {
                throw new IllegalArgumentException("Expected string for enum value; got "
                        + jsonVal.getClass().getName());
            }
     ...
     */
    private static void populateObjectFromJsonObject(
            final Object objectInstance,
            final Type objectResolvedType,
            final Object jsonVal,
            final ClassFieldCache classFieldCache,
            final Map<CharSequence, Object> idToObjectInstance,
        ...
        if (!(isJsonArray || isJsonObject)) {
            throw new IllegalArgumentException("Expected JSONObject or JSONArray, got "
        ...
        if ((isMap || isObj) != isJsonObject || (isCollection || isArray) != isJsonArray) {
            throw new IllegalArgumentException(
                    "Wrong JSON type for class " + objectInstance.getClass().getName());
        }
        ...
        if (objectResolvedTypeGeneric instanceof Class<?>) {
            ...
            commonResolvedValueType = isMap
                    ? typeResolutions.resolvedTypeArguments[1]
        ...
        final Class<?> commonValueRawType =
                commonResolvedValueType == null ? null : JSONUtils.getRawType(commonResolvedValueType);
        ...
        final int numItems = jsonObject != null
                ? jsonObject.items.size()
        ...
        for (int i = 0; i < numItems; i++) {
            ...
            final Type resolvedItemValueType =
                    ...
                    fieldTypeInfo != null
                            ? fieldTypeInfo.getFullyResolvedFieldType(typeResolutions)
            ...
            if (itemJsonValue == null) {
                ...
                if (itemJsonValueIsJsonObject) {
                    ...
                    itemsToRecurseToInPass2.add(new ObjectInstantiation(
                            instantiatedItemObject, ParameterizedTypeImpl.MAP_OF_UNKNOWN_TYPE, itemJsonValue));
                    ...
                    itemsToRecurseToInPass2.add(new ObjectInstantiation(
                            instantiatedItemObject, ParameterizedTypeImpl.LIST_OF_UNKNOWN_TYPE, itemJsonValue));

                } else {
                    // Deserialize basic JSON value for assigning to Object-typed field or as Object-typed element
                    instantiatedItemObject = jsonBasicValueToObject(
                            itemJsonValue, resolvedItemValueType, /* convertStringToNumber = */ false);
                }
                    ...
                    try {
                        ...
                        if ((resolvedItemValueType instanceof Class<?>
                            ...
                            if (!itemJsonValueIsJsonArray) {
                                throw new IllegalArgumentException("Expected JSONArray, got "
                                        + itemJsonValue.getClass().getName());
                            }
                            ...
                            if (isCollection || isMap || is1DArray) {
                                ...
                                final Constructor<?> valueConstructorWithSizeHint =
                                        fieldTypeInfo.getConstructorForFieldTypeWithSizeHint(
                                                resolvedItemValueType, classFieldCache);
            ...
            if (fieldTypeInfo != null) {
                ...
                final Object mapKey =
                        jsonBasicValueToObject(itemJsonKey, mapKeyType, /* convertStringToNumber = */ true);
     ...
     */
    private static Map<CharSequence, Object> getInitialIdToObjectMap(
            final Object objectInstance, final Object parsedJSON) {
    ...
    private static <T> T deserializeObject(
            final Class<T> expectedType, final String json, final ClassFieldCache classFieldCache)
            throws IllegalArgumentException {
        // Parse the JSON
        Object parsedJSON;
        try {
        ...
        populateObjectFromJsonObject(
                ...
                parsedJSON,
                classFieldCache,
                getInitialIdToObjectMap(objectInstance, parsedJSON),
                collectionElementAdders);
    ...
    public static <T> T deserializeObject(
            final Class<T> expectedType, final String json, final ReflectionUtils reflectionUtils)
            throws IllegalArgumentException {
        final ClassFieldCache classFieldCache = new ClassFieldCache(
                /* resolveTypes = */ true, /* onlySerializePublicFields = */ false, reflectionUtils);
     ...
     *             If anything goes wrong during deserialization.
     */
    public static void deserializeToField(
    ...
    public static void deserializeToField(
            ...
            throws IllegalArgumentException {
        final ClassFieldCache typeCache = new ClassFieldCache(
                /* resolveTypes = */ true, /* onlySerializePublicFields = */ false, reflectionUtils);
