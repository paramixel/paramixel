...
class ObjectTypedValueWrapper extends ScanResultObject {
    ...
    Object instantiateOrGet(final ClassInfo annotationClassInfo, final String paramName) {
        ...
        if (annotationEnumValue != null) {
            ...
            final Object annotationValueObjectArray = eltClass == null
                    ? new Object[objectArrayValue.length]
     ...
     *         a String.
     */
    private Object getArrayValueClassOrName(
            final ClassInfo annotationClassInfo, final String paramName, final boolean getClass) {
        // Find the method in the annotation class with the same name as the annotation parameter.
        final MethodInfoList annotationMethodList =
                annotationClassInfo == null || annotationClassInfo.methodInfo == null
                        ? null
        ...
        if (annotationClassInfo != null && annotationMethodList != null && !annotationMethodList.isEmpty()) {
            ...
            final TypeSignature annotationMethodResultTypeSig = annotationMethodList
                    .get(0)
            ...
            for (final ObjectTypedValueWrapper elt : objectArrayValue) {
                if (elt != null) {
                    ...
                    return elt.integerValue != null
                            ? (getClass ? Integer.class : "int")
                            : elt.longValue != null
                                    ? (getClass ? Long.class : "long")
                                    : elt.shortValue != null
                                            ? (getClass ? Short.class : "short")
                                            : elt.characterValue != null
                                                    ? (getClass ? Character.class : "char")
                                                    : elt.byteValue != null
                                                            ? (getClass ? Byte.class : "byte")
                                                            : elt.booleanValue != null
                                                                    ? (getClass ? Boolean.class : "boolean")
                                                                    : elt.doubleValue != null
                                                                            ? (getClass ? Double.class : "double")
                                                                            : elt.floatValue != null
                                                                                    ? (getClass ? Float.class : "float")
                                                                                    : (getClass
                                                                                            ? elt.getClass()
                                                                                            : elt.getClass()
                                                                                                    .getName());
    ...
    void convertWrapperArraysToPrimitiveArrays(final ClassInfo annotationClassInfo, final String paramName) {
        if (annotationInfo != null) {
            ...
            // Find the method in the annotation class with the same name as the annotation parameter.
            final String targetElementTypeName =
                    (String) getArrayValueClassOrName(annotationClassInfo, paramName, /* getClass = */ false);
    ...
    public int hashCode() {
        return Objects.hash(
                ...
                doubleValue,
                byteValue,
                Arrays.hashCode(stringArrayValue),
                Arrays.hashCode(intArrayValue),
                Arrays.hashCode(longArrayValue),
                Arrays.hashCode(shortArrayValue),
                Arrays.hashCode(booleanArrayValue),
                Arrays.hashCode(charArrayValue),
                Arrays.hashCode(floatArrayValue),
                Arrays.hashCode(doubleArrayValue),
                Arrays.hashCode(byteArrayValue),
    ...
    public boolean equals(final Object other) {
        ...
        return Objects.equals(annotationEnumValue, o.annotationEnumValue)
                ...
                && Objects.equals(annotationInfo, o.annotationInfo)
                && Objects.equals(stringValue, o.stringValue)
                && Objects.equals(integerValue, o.integerValue)
                && Objects.equals(longValue, o.longValue)
                && Objects.equals(shortValue, o.shortValue)
                && Objects.equals(booleanValue, o.booleanValue)
                && Objects.equals(characterValue, o.characterValue)
                && Objects.equals(floatValue, o.floatValue)
                && Objects.equals(doubleValue, o.doubleValue)
                && Objects.equals(byteValue, o.byteValue)
                && Arrays.equals(stringArrayValue, o.stringArrayValue)
                && Arrays.equals(intArrayValue, o.intArrayValue)
                && Arrays.equals(longArrayValue, o.longArrayValue)
