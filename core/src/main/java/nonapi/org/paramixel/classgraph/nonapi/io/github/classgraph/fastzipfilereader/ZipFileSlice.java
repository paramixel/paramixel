...
public class ZipFileSlice {
    ...
    /* (non-Javadoc)
     * @see nonapi.nonapi.org.paramixel.classgraph.io.github.classgraph.fastzipfilereader.ZipFileSlice#equals(java.lang.Object)
     */
    @Override
    public boolean equals(final Object o) {
        if (o == this) {
            ...
            return Objects.equals(physicalZipFile, other.physicalZipFile)
    ...
    /* (non-Javadoc)
     * @see nonapi.nonapi.org.paramixel.classgraph.io.github.classgraph.fastzipfilereader.ZipFileSlice#hashCode()
     */
    @Override
    public int hashCode() {
    ...
    public String toString() {
        ...
        String fileStr = physicalZipFile.getPath() == null
                ? null
                : physicalZipFile.getPath().toString();
        if (fileStr == null) {
            fileStr = physicalZipFile.getFile() == null
                    ? null
                    : physicalZipFile.getFile().toString();
        }
