...
public class FastZipEntry implements Comparable<FastZipEntry> {
    ...
    FastZipEntry(
            ...
            final int lastModifiedTimeMSDOS,
            final int lastModifiedDateMSDOS,
        ...
        if (entryName.startsWith(LogicalZipFile.MULTI_RELEASE_PATH_PREFIX)
            ...
            if (nextSlashIdx > 0) {
                ...
                final String versionStr =
                        entryName.substring(LogicalZipFile.MULTI_RELEASE_PATH_PREFIX.length(), nextSlashIdx);
    ...
    public Slice getSlice() throws IOException {
        if (slice == null) {
            ...
            final long dataStartPos = locHeaderPos
                    + 30
                    + randomAccessReader.readShort(locHeaderPos + 26)
