...
import nonapi.org.paramixel.classgraph.io.github.classgraph.Resource;
...
public abstract class Slice implements Closeable {
    ...
    protected Slice(
        ...
        if (parentSlice != null
                && (sliceStartPos < parentSliceStartPos
    ...
    public int hashCode() {
        if (hashCode == 0) {
            hashCode = (parentSlice == null ? 1 : parentSlice.hashCode())
                    ^ ((int) sliceStartPos * 7)
                    ^ ((int) sliceLength * 15);
            if (hashCode == 0) {
                hashCode = 1;
    ...
    public boolean equals(final Object o) {
        if (o == this) {
            ...
            return this.parentSlice == other.parentSlice
                    && this.sliceStartPos == other.sliceStartPos
