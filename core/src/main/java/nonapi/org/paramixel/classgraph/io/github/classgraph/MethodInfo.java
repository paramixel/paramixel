...
import nonapi.org.paramixel.classgraph.io.github.classgraph.Classfile.MethodTypeAnnotationDecorator;
...
public class MethodInfo extends ClassMemberInfo implements Comparable<MethodInfo> {
                ...
                try {
                    ...
                    if (typeAnnotationDecorators != null) {
                        ...
                        if (sig == null) {
                            ...
                            final int descNumParam =
                                    typeDescriptor.getParameterTypeSignatures().size();
                            ...
                            if (numImplicitPrefixParams < 0) {
                                ...
                                final List<TypeSignature> strippedParamSigs =
                                        paramSigs.subList(0, numImplicitPrefixParams);
            ...
            if (parameterInfo == null) {
                ...
                if (parameterModifiers != null && parameterModifiers.length > 0) {
                    if (parameterModifiers.length == numParams) {
                        ...
                        for (int i = 0, lenDiff = numParams - parameterModifiers.length;
                                i < parameterModifiers.length;
                                i++) {
                ...
                if (parameterAnnotationInfo != null && parameterAnnotationInfo.length > 0) {
                    if (parameterAnnotationInfo.length == numParams) {
                        ...
                        for (int i = 0, lenDiff = numParams - parameterAnnotationInfo.length;
                                i < parameterAnnotationInfo.length;
                                i++) {
            ...
            for (int i = 0; i < parameterAnnotationInfo.length; i++) {
                ...
                if (pai != null && pai.length > 0) {
                    ...
                    if (hasRepeatableAnnotation) {
                        ...
                        aiList.handleRepeatableAnnotations(
                                allRepeatableAnnotationNames,
                                getClassInfo(),
    ...
    public boolean equals(final Object obj) {
        ...
        return declaringClassName.equals(other.declaringClassName)
                && typeDescriptorStr.equals(other.typeDescriptorStr)
    ...
    protected void toString(final boolean useSimpleNames, final StringBuilder buf) {
        ...
        if (!isConstructor()) {
            ...
            methodType
                    .getResultType()
                    .toStringInternal(useSimpleNames, /* annotationsToExclude = */ annotationInfo, buf);
        }
        ...
        if (!methodType.getThrowsSignatures().isEmpty()) {
            ...
            if (thrownExceptionNames != null && thrownExceptionNames.length > 0) {
                ...
                for (int i = 0; i < thrownExceptionNames.length; i++) {
                    ...
                    buf.append(
                            useSimpleNames
                                    ? ClassInfo.getSimpleName(thrownExceptionNames[i])
