...
public final class SystemJarFinder {
                    ...
                    if (filePath.endsWith(".jar")) {
                        ...
                        try {
                            ...
                            if (!canonicalFilePath.equals(filePath)) {
                                final String canonicalJarPathResolved =
                                        FastPathResolver.resolve(FileUtils.currDirPath(), filePath);
    ...
    static {
        ...
        RT_JAR = RT_JARS.isEmpty()
                ? null
                : FastPathResolver.resolve(RT_JARS.iterator().next());
    }
