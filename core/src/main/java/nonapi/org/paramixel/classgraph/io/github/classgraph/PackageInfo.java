...
public class PackageInfo implements Comparable<PackageInfo>, HasName {
    ...
    public ClassInfoList getClassInfo() {
        return memberClassNameToClassInfo == null
                ? ClassInfoList.EMPTY_LIST
     ...
     */
    static PackageInfo getOrCreatePackage(
        ...
        if (!packageName.isEmpty()) {
            ...
            if (scanSpec.packageAcceptReject.isAcceptedAndNotRejected(parentPackageName)
                ...
                final PackageInfo parentPackageInfo =
                        getOrCreatePackage(parentPackageName, packageNameToPackageInfo, scanSpec);
