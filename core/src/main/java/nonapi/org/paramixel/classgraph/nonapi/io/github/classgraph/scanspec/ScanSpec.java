...
package nonapi.org.paramixel.classgraph.nonapi.io.github.classgraph.scanspec;
...
import nonapi.org.paramixel.classgraph.io.github.classgraph.ModulePathInfo;
import nonapi.org.paramixel.classgraph.io.github.classgraph.ScanResult;
import nonapi.org.paramixel.classgraph.nonapi.io.github.classgraph.scanspec.AcceptReject.AcceptRejectLeafname;
import nonapi.org.paramixel.classgraph.nonapi.io.github.classgraph.scanspec.AcceptReject.AcceptRejectPrefix;
import nonapi.org.paramixel.classgraph.nonapi.io.github.classgraph.scanspec.AcceptReject.AcceptRejectWholeString;
...
public class ScanSpec {
    ...
    public void addClasspathOverride(final Object overrideClasspathElement) {
        ...
        this.overrideClasspath.add(
                overrideClasspathElement instanceof String
                                || overrideClasspathElement instanceof URL
                                || overrideClasspathElement instanceof URI
                        ? overrideClasspathElement
    ...
    public ScanSpecPathMatch dirAcceptMatchStatus(final String relativePath) {
        ...
        if (pathAcceptReject.acceptIsEmpty() && classPackagePathAcceptReject.acceptIsEmpty()) {
            ...
            return relativePath.isEmpty() || relativePath.equals("/")
                    ? ScanSpecPathMatch.AT_ACCEPTED_PATH
