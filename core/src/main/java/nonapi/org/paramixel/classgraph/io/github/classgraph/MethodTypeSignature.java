...
public final class MethodTypeSignature extends HierarchicalTypeSignature {
    ...
    private MethodTypeSignature(
            final List<TypeParameter> typeParameters,
            final List<TypeSignature> paramTypes,
            final TypeSignature resultType,
    ...
    public int hashCode() {
        return typeParameters.hashCode()
                + parameterTypeSignatures.hashCode() * 7
                + resultType.hashCode() * 15
    ...
    public boolean equals(final Object obj) {
        ...
        return o.typeParameters.equals(this.typeParameters)
                ...
                && o.resultType.equals(this.resultType)
                && o.throwsSignatures.equals(this.throwsSignatures);
    }
    ...
    static MethodTypeSignature parse(final String typeDescriptor, final String definingClassName)
        ...
        if (typeDescriptor.equals("<init>")) {
            ...
            return new MethodTypeSignature(
                    ...
                    Collections.<TypeSignature>emptyList(), /* void */
                    new BaseTypeSignature('V'),
            ...
            while (parser.peek() == '^') {
                ...
                if (classTypeSignature != null) {
                    ...
                    final TypeVariableSignature typeVariableSignature =
                            TypeVariableSignature.parse(parser, definingClassName);
        ...
        final MethodTypeSignature methodSignature =
                new MethodTypeSignature(typeParameters, paramTypes, resultType, throwsSignatures);
