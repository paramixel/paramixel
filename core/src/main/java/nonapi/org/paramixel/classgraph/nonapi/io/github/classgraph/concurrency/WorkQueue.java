...
public class WorkQueue<T> implements AutoCloseable {
    ...
    public static <U> void runWorkQueue(
        ...
        try (WorkQueue<U> workQueue =
                new WorkQueue<>(elements, workUnitProcessor, numParallelTasks, interruptionChecker, log)) {
     ...
     */
    private WorkQueue(
            final Collection<T> initialWorkUnits,
