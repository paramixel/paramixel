...
abstract class ReflectionDriver {
    ...
    protected Field findField(final Class<?> cls, final Object obj, final String fieldName) throws Exception {
        final Field field = classToClassMemberCache
                .get(cls, /* log = */ null)
                .fieldNameToField
                .get(fieldName);
        if (field != null) {
    ...
    protected Method findMethod(
            final Class<?> cls, final Object obj, final String methodName, final Class<?>... paramTypes)
            throws Exception {
        final List<Method> methodsForName =
                classToClassMemberCache.get(cls, null).methodNameToMethods.get(methodName);
        if (methodsForName != null) {
