...
public final class JSONSerializer {
     ...
     */
    private static void assignObjectIds(
        ...
        if (jsonVal instanceof JSONObject) {
            ...
            for (final Object item : ((JSONArray) jsonVal).items) {
                assignObjectIds(
                        item, objToJSONVal, classFieldCache, jsonReferenceToId, objId, onlySerializePublicFields);
            }
     ...
     *            whether to only serialize public fields
     */
    private static void convertVals(
            final Object[] convertedVals,
            final Set<ReferenceEqualityKey<Object>> visitedOnPath,
            final Set<ReferenceEqualityKey<Object>> standardObjectVisited,
            final ClassFieldCache classFieldCache,
            final Map<ReferenceEqualityKey<Object>, JSONObject> objToJSONVal,
            final boolean onlySerializePublicFields) {
        ...
        for (int i = 0; i < convertedVals.length; i++) {
            if (needToConvert[i]) {
                ...
                final Object val = convertedVals[i];
                convertedVals[i] = toJSONGraph(
                        val,
                        visitedOnPath,
                        standardObjectVisited,
                        classFieldCache,
                        objToJSONVal,
                        onlySerializePublicFields);
    ...
    private static Object toJSONGraph(
            final Object obj,
            final Set<ReferenceEqualityKey<Object>> visitedOnPath,
            final Set<ReferenceEqualityKey<Object>> standardObjectVisited,
            final ClassFieldCache classFieldCache,
        ...
        if (Map.class.isAssignableFrom(cls)) {
            ...
            for (int i = 0; i < n; i++) {
                ...
                if (key != null && !JSONUtils.isBasicValueType(key)) {
                    throw new IllegalArgumentException(
                            "Map key of type " + key.getClass().getName()
            ...
            for (int i = 0; i < n; i++) {
                ...
                try {
                    ...
                    throw new RuntimeException(
                            "Could not get value of field \"" + fieldNames[i] + "\" in object of class "
    ...
    static void jsonValToJSONString(
        ...
        if (jsonVal == null) {
            ...
            final Object referencedObjectId =
                    jsonReferenceToId.get(new ReferenceEqualityKey<>((JSONReference) jsonVal));
            jsonValToJSONString(
                    referencedObjectId, jsonReferenceToId, includeNullValuedFields, depth, indentWidth, buf);

        } else if (jsonVal instanceof CharSequence
                || jsonVal instanceof Character
    ...
    public static String serializeObject(
        ...
        final Object rootJsonVal = toJSONGraph(
                obj,
                new HashSet<ReferenceEqualityKey<Object>>(),
                new HashSet<ReferenceEqualityKey<Object>>(),
                classFieldCache,
                objToJSONVal,
                onlySerializePublicFields);
        ...
        assignObjectIds(
                rootJsonVal, objToJSONVal, classFieldCache, jsonReferenceToId, objId, onlySerializePublicFields);
     ...
     */
    public static String serializeObject(
            final Object obj, final int indentWidth, final boolean onlySerializePublicFields) {
     ...
     *             If anything goes wrong during serialization.
     */
    public static String serializeFromField(
        ...
        final FieldTypeInfo fieldResolvedTypeInfo = classFieldCache
                .get(containingObject.getClass())
                .fieldNameToFieldTypeInfo
                .get(fieldName);
        if (fieldResolvedTypeInfo == null) {
            throw new IllegalArgumentException("Class "
                    + containingObject.getClass().getName() + " does not have a field named \"" + fieldName + "\"");
        }
        final Field field = fieldResolvedTypeInfo.field;
        if (!JSONUtils.fieldIsSerializable(
                field, /* onlySerializePublicFields = */ false, classFieldCache.reflectionUtils)) {
            throw new IllegalArgumentException(
                    "Field " + containingObject.getClass().getName() + "." + fieldName
    ...
    public static String serializeFromField(
        ...
        final ClassFieldCache classFieldCache =
                new ClassFieldCache(/* resolveTypes = */ false, onlySerializePublicFields, reflectionUtils);
    ...
    public static String serializeFromField(
            ...
            final int indentWidth,
            final boolean onlySerializePublicFields) {
        return serializeFromField(
                containingObject, fieldName, indentWidth, onlySerializePublicFields, new ReflectionUtils());
    }
}
