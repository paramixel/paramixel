...
class EquinoxContextFinderClassLoaderHandler implements ClassLoaderHandler {
    ...
    public static boolean canHandle(final Class<?> classLoaderClass, final LogNode log) {
        return ClassLoaderFinder.classIsOrExtendsOrImplements(
                classLoaderClass, "org.eclipse.osgi.internal.framework.ContextFinder");
    }
    ...
    public static void findClassLoaderOrder(
        ...
        classLoaderOrder.delegateTo(
                (ClassLoader)
                        classLoaderOrder.reflectionUtils.getFieldVal(false, classLoader, "parentContextClassLoader"),
                /* isParent = */ true,
                log);
