...
public final class ClassRefTypeSignature extends ClassRefOrTypeVariableSignature {
     ...
     *            The suffix type arguments.
     */
    private ClassRefTypeSignature(
            final String className,
            final List<TypeArgument> typeArguments,
            final List<String> suffixes,
            final List<List<TypeArgument>> suffixTypeArguments) {
        super();
    ...
    protected void addTypeAnnotation(final List<TypePathNode> typePath, final AnnotationInfo annotationInfo) {
        ...
        for (; ; ) {
            ...
            if (suffixIdx >= suffixes.size()) {
                ...
                skipSuffix = outerClassInfo == null
                        || innerClassInfo == null
        ...
        if (nextTypeArgIdx == -1) {
            ...
            final List<TypeArgument> typeArgumentList =
                    suffixIdx == -1 ? typeArguments : suffixTypeArguments.get(suffixIdx);
            ...
            if (nextTypeArgIdx < typeArgumentList.size()) {
                ...
                final List<TypePathNode> remainingTypePath =
    ...
    public int hashCode() {
        return className.hashCode()
                + 7 * typeArguments.hashCode()
                + 15 * suffixTypeArguments.hashCode()
    ...
    public boolean equals(final Object obj) {
        ...
        return o.className.equals(this.className)
                && o.typeArguments.equals(this.typeArguments)
                && Objects.equals(this.typeAnnotationInfo, o.typeAnnotationInfo)
                && suffixesMatch(o, this);
    }

    /* (non-Javadoc)
     * @see nonapi.org.paramixel.classgraph.io.github.classgraph.TypeSignature#equalsIgnoringTypeParams(nonapi.org.paramixel.classgraph.io.github.classgraph.TypeSignature)
     */
    @Override
    ...
    protected void toStringInternal(
        ...
        if (!suffixes.isEmpty()) {
            for (int i = useSimpleNames ? suffixes.size() - 1 : 0; i < suffixes.size(); i++) {
                ...
                final AnnotationInfoList typeAnnotations =
                        suffixTypeAnnotations == null ? null : suffixTypeAnnotations.get(i);
        ...
        if (parser.peek() == 'L') {
            ...
            if (parser.peek() == '.' || parser.peek() == '$') {
                ...
                if (dropSuffixes) {
                    ...
                    className = parser.getSubstring(startParserPosition, parser.getPosition())
                            .replace('/', '.');
