...
public final class URLPathEncoder {
    ...
    public static String normalizeURLPath(final String urlPath) {
        ...
        if (!urlPathNormalized.startsWith("jrt:")
                && !urlPathNormalized.startsWith("http://")
            ...
            if (VersionFinder.OS == OperatingSystem.Windows) {
                if (urlPathNormalized.length() >= 2
                        && Character.isLetter(urlPathNormalized.charAt(0))
                ...
                } else if (urlPathNormalized.length() >= 3
                        && urlPathNormalized.charAt(0) == '/'
                        && Character.isLetter(urlPathNormalized.charAt(1))
                        && urlPathNormalized.charAt(2) == ':') {
                    // Path of form "/C:/xyz"
            ...
            urlPathNormalized =
                    urlPathNormalized.replace("/!", "!").replace("!/", "!").replace("!", "!/");
