 ...
 * not properties of reusable {@link org.paramixel.api.action.Action} definitions.
 *
 * @see Metadata#mode()
 */
public enum Mode {
     ...
     */
    public org.paramixel.api.Status toStatus() {
        return switch (this) {
            case RUN -> org.paramixel.api.Status.PASSED;
            case SKIP -> org.paramixel.api.Status.SKIPPED;
            case ABORT -> org.paramixel.api.Status.ABORTED;
        };
    }
     ...
     */
    public static Mode fromStatus(final org.paramixel.api.Status status) {
