...
public final class ResourceLoader {
    ...
    public static InputStream getResourceAsStream(final String name) {
        ...
        if (contextClassLoader != null) {
            final var stream = contextClassLoader.getResourceAsStream(name);
            if (stream != null) {
                return stream;
            }
        }
     ...
     *     ClassLoader
     */
    public static InputStream getResourceAsStream(final String name, final ClassLoader classLoader) {
        if (classLoader != null) {
            final var stream = classLoader.getResourceAsStream(name);
            if (stream != null) {
                return stream;
            }
        }
    ...
    private static InputStream getResourceAsStreamWithoutContext(final String name) {
        final var definingClassLoader = ResourceLoader.class.getClassLoader();
