...
public class StoreTest2 {
    ...
    public void beforeAll(final @NonNull ArgumentContext argumentContext) {
        ...
        argumentContext.getClassContext().getStore().put(scopedName(Key.MAP_TEST_2_CLASS_CONTEXT_KEY), "class");
    ...
    public void verifyMaps(final @NonNull ArgumentContext argumentContext) {
        ...
        Object classValue =
                argumentContext.getClassContext().getStore().get(scopedName(Key.MAP_TEST_2_CLASS_CONTEXT_KEY));
        ...
        argumentContext.getStore().put(scopedName(Key.MAP_TEST_2_ARGUMENT_CONTEXT_KEY), "argument");
        assertThat(argumentContext.getStore().get(scopedName(Key.MAP_TEST_2_ARGUMENT_CONTEXT_KEY)))
                .isEqualTo("argument");
    }
    ...
    public void finalize(final ClassContext classContext) {
        Object engineRemoved =
                classContext.getEngineContext().getStore().remove(scopedName(Key.MAP_TEST_2_ENGINE_CONTEXT_KEY));
        Object classRemoved = classContext.getStore().remove(scopedName(Key.MAP_TEST_2_CLASS_CONTEXT_KEY));
    ...
    private static String argumentKey(final @NonNull ArgumentContext argumentContext) {
        return scopedName(Key.MAP_TEST_2_ARGUMENT_CONTEXT_KEY) + "." + argumentContext.getArgumentIndex();
    }
}
