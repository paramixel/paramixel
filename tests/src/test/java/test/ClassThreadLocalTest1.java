 ...
 *
 * <p>This test uses a {@link ThreadLocal} field to validate that the test instance is available
 * and that initialization can safely interact with instance state.
 */
public class ClassThreadLocalTest1 {
