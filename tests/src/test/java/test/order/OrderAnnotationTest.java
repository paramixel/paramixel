...
@Paramixel.TestClass
/**
 * Verifies that {@link Paramixel.Order} controls the execution order of test methods.
 *
 * <p>This test appends method identifiers to a list stored in the class store and asserts that the
 * final order matches the expected ordering by {@code @Paramixel.Order}.
 */
public class OrderAnnotationTest {
    ...
    public void finalize(final ClassContext context) {
        ...
        assertThat(order).isNotNull().containsExactly("alpha", "beta", "zeta");
    }
