...
Default scheduler parallelism. Defaults to `Runtime.getRuntime().availableProcessors()`.
...
Use `ExecutionContext#configuration()` in context-mode steps or custom actions:
