      ...
      ({
        docs: {
          ...
          versions: {
            ...
            '6.2.2': {
              banner: 'unmaintained',
              label: '6.2.2 (Unmaintained)',
              className: 'notice-unmaintained',
            },
            '6.2.1': {
              banner: 'unmaintained',
              label: '6.2.1 (Unmaintained)',
              className: 'notice-unmaintained',
            },
            '6.2.0': {
              banner: 'unmaintained',
              label: '6.2.0 (Unmaintained)',
              className: 'notice-unmaintained',
            },
            '6.1.0': {
              banner: 'unmaintained',
              label: '6.1.0 (Unmaintained)',
              className: 'notice-unmaintained',
            },
            '6.0.0': {
              banner: 'unmaintained',
              label: '6.0.0 (Unmaintained)',
              className: 'notice-unmaintained',
            },
            '5.1.1': {
              banner: 'unmaintained',
              label: '5.1.1 (Unmaintained)',
              className: 'notice-unmaintained',
            },
            '5.1.0': {
              banner: 'unmaintained',
              label: '5.1.0 (Unmaintained)',
              className: 'notice-unmaintained',
            },
            '5.0.0': {
              banner: 'unmaintained',
              label: '5.0.0 (Unmaintained)',
              className: 'notice-unmaintained',
            },
            '4.0.0': {
              banner: 'unmaintained',
              label: '4.0.0 (Unmaintained)',
              className: 'notice-unmaintained',
            },
            '3.0.1': {
              banner: 'unmaintained',
              label: '3.0.1 (Unmaintained)',
              className: 'notice-unmaintained',
            },
            '2.0.0': {
              banner: 'unmaintained',
              label: '2.0.0 (Unmaintained)',
              className: 'notice-unmaintained',
            },
            '1.0.2': {
              banner: 'unmaintained',
              label: '1.0.2 (Unmaintained)',
              className: 'notice-unmaintained',
            },
          },
        },
