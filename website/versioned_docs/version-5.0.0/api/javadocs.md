...
| Package | Contents |
| --- | --- |
| `org.paramixel.api` | Runner, Configuration, Listener, Result, Status, Paramixel (annotations), AnnotationResolver, Version, ThrowingRunnable, ThrowingConsumer |
| `org.paramixel.api.action` | Action, Spec, Step, Lifecycle, Sequential, Parallel, Instance, Static, Repeat, Timeout, Delay, AssertTrue, AssertFalse, Descriptor, Metadata |
...
| `org.paramixel.spi.action` | ExecutionContext, Mode |
