...
`paramixel.failureOnAbort` defaults to `true`; aborted results produce failing exit codes by default. Set `paramixel.failureOnSkip=true` if skipped results should also fail CI.
